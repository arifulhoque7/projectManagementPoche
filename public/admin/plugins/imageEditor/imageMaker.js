        ...
        $(this).each(function(delta) {
            ...
            var canvas_info = {
                ...
                i18n: {
                    ...
                    previewText: 'Preview',
                    addTemplateText: 'Add Image',
                    resetText: 'Reset',
                    imageGeneratorText: 'Download Image',
                    stopBrushingText: 'Stop Brushing',
                    canvasLoadingText: 'Canvas Loading'
                },
                weight: "brushes",
                /*Order of Draw the Possibilities('brushes', 'text', 'images')*/
            ...
            container.on('click', ".add_textbox", function(event) {
                ...
                container.find('#' + text_info.id_box).draggable({
                    ...
                    }).css({ border: "1px dashed white", position: "absolute", width: canvas_info.final_width + "px", height: canvas_info.height_div + "px" }).animate({
                        opacity: 0
                    }, 1000, function() {
            ...
            function amm_add_image_load(image_info) {
                ...
                image_info.img.onload = function() {
                    ...
                    container.find('#' + image_info.id).draggable({
                        ...
                        minHeight: 50,
                        minWidth: 50
                    }).css({ border: "1px dashed white", position: "absolute", width: image_info.width + "px", height: image_info.height + "px" }).animate({
                        opacity: 0
                    }, 1000, function() {
            ...
            container.find(".replace_image").click(function(event) {
                if (!canvas_info.downloadGeneratedImage) {
                    event.preventDefault();
                }
                var _this = $(this);
